...
<form  action="rechercherclient.php"method="POST">
    <br>
<div class="main"  >
    <div id="responsable"><h1 style="color:red">Clients</h1>
    <p style="color:white; "> Rechercher_les clients:  </p>
          
   <h5 style="color:white">cin <input type="text" name="cin"></h5>
    
   <input type="submit" value="rechercher"  ></div></div></form>
    <br>
    <br>
    <br>   <form action="consulterclient.php" method="POST">
    <div class="main"  >
    <div id="responsable">
    <p><h4  style="color:white "> consulter_les_clients</h4> </p>
        
  <input type="submit" value="consulter"  ></a></form>
    <br>
    <br>
    <br><form method="POST" action="ajouterclient.php">
   <p style="color:white"><b> ajouter_un_client_cliquer_sur_ce_lien</b> </p>
