...
while($row=mysqli_fetch_array($query)){
    ...
    ?>
                ...
                <table>
                <tr><th>date du prise en charge:</th>
    ...
    ?> </td></tr></table>
                        ...
                        <table>
                <tr><th>lieu du prise en charge:</th>
    ...
    ?> </td></tr></table>
                ...
                <tr><th>cin du client</th>
                    <td colspan="2"><?php echo $row ["client_cin1"];
   ...
   <form action="supprimerreservation.php" method="POST"><input type="submit" value="supprimer"  >
