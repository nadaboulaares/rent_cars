...
><form  action="recherchervoit.php"method="POST">
    <br>
<div class="main"  >
    <div id="responsable"><h2 style="color:red; "> voitures</h2>
    <p style="color:White; "> Rechercher_les_voitures 
        <br>
          
    Matricule <input type="text" name="mat"></p>
    
   <input type="submit" value="rechercher"  ></div></div></form>
    <br>
    <br>
    <br>   <form action="consultervoit.php" method="POST">
    <div class="main"  >
    <div id="responsable">
    <p style="color:White; "> consulter_les_voitures</p>
        
  <input type="submit" value="consulter"  ></a></form>
    <br>
    <br>
    <br><form method="POST" action="ajoutervoiture.php">
   <p style="color:White; "><b> ajouter_une_voiture,cliquer_sur_ce_lien</b> </p>
