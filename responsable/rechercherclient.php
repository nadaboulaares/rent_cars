...
$req = "select * from client where cin=$cine";
...
while($row=mysqli_fetch_array($query)){
    ...
    ?> </td></tr></table>
                                       <table>
                <tr><th>nationnalite:</th>
                    <td colspan="2"><?php echo $row ["nationalite"];
    
    
    
    ?>
                    </td></tr></table>    <input type="submit" value="modifier"  ></form>
   <form action="supprimerclient.php" method="POST"><input type="submit" value="supprimer"  >
   </div></form></div>
                    </td></tr></table>
                    </td></tr></table>
                    </td></tr></table>
